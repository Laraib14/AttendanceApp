        ...
        Glide.with(this)
                ...
                .listener(new RequestListener<Uri, GlideDrawable>() {
                    ...
                    public boolean onResourceReady(GlideDrawable resource, Uri model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                        ...
                        Log.d("kest",imageUri+"");
                        Log.d(TAG, "Glide Success Loading image from uri : " + imageUri.getPath());
                        return false;
                    }
                })
                .into(getImageView());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /*else if(requestCode == PLACE_PICKER_REQUEST && resultCode == RESULT_OK) {
            ...
            *//*mPlacePickerButton.setText(placeName);
            ...
            Log.d("test","Selected Place: "+place.getName());
        }*/
    }
    ...
    protected void handleCropImageResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Log.d(TAG, "crop image error", result.getError());
